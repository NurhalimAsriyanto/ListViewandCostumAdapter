package com.gmail.halimgenza.listviewandcostumadapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    int flags[] = {R.drawable.buah, R.drawable.buah, R.drawable.buah, R.drawable.buah, R.drawable.buah, R.drawable.buah};
